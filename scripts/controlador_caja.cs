...
public class controlador_caja : MonoBehaviour
{
    ...
    public float requiredHoldTime = 4f; // Tiempo necesario para mantener presionada la tecla L o fire1
    ...
    void Update()
    {
        ...
        if ((Input.GetKey(KeyCode.L) || Input.GetButton("Fire2")) && Flagcaja)
        {
    ...
    public void OnPointerEnter()
    {
        ...
        {
            AddOnePoint();
            carta.text = "Mantén presionado el botón L (B en el mando) para activar la magia y desplazar la caja";
            Flagcaja = true;
        }
    }
